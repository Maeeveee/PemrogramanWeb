...
echo "Daftar karyawan dengan pengalaman lebih dari 5 tahun : " . implode(", ", $karyawanPengalamanLimaTahun) . "<br>";
...
$totalNilai = 0;
$nilaiSiswaSoal = [['Alice',85],['Bob',92],['Charlie',78],['David',64],['Eva',90]];
foreach ($nilaiSiswaSoal as $nilai) {
    $totalNilai += $nilai[1];
    $nilaiRata = $totalNilai / 5;
}
